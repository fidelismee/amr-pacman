...
const TouchController = ({ 
  ...
  const getButtonStyles = (isDisabled: boolean) => 
    `w-full h-full rounded-xl flex items-center justify-center text-3xl transition-all duration-150 active:scale-95 ${
      isDisabled 
  ...
  return (
    <div className="relative w-full max-w-sm md:max-w-md mx-auto">
      ...
      <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 p-4 md:p-8 rounded-xl md:rounded-2xl border-2 border-gray-700 shadow-inner">
        ...
        */}
        <div className="grid grid-cols-3 grid-rows-2 gap-2 md:gap-3 w-48 h-32 md:w-64 md:h-44 mx-auto">
